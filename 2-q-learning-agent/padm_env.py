...
class ShariqQuestEnv(gym.Env):
    ...
    """
    def __init__(self, grid_size=7, goal_coordinates=(0, 6)) -> None:
...
def create_env(goal_coordinates, hell_state_coordinates, obstacle_coordinates):
    """
    ...
    """
    env = ShariqQuestEnv(goal_coordinates=goal_coordinates)
